    ...
    if(BinaryOperator::classof(E)){
      ...
      if(BinaryOperator::classof(rhs)){
        ...
        // if(ImplicitCastExpr::classof(rhs)){
          ...
          // ValueDecl* lhs_decl = lhs_declRef -> getDecl();
          // 根据C的Decl从局部变量表中取到C对应的LLVM Value
          // baseC = LocalDeclMap.lookup((Decl*)lhs_decl);
          ...
          // 拿到A对应的Decl
          // const ValueDecl* rhs_decl = rhs_declRef -> getDecl();
          // ValueDecl* rhs_decl = rhs_declRef -> getDecl();
          // 根据A的Decl从局部变量表中取到A对应的LLVM Value
          // baseA = LocalDeclMap.lookup((Decl*)rhs_decl);
          // baseA = LocalDeclMap.lookup(rhs_decl);
